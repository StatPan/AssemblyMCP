...
async def test_get_legislative_reports(smart_service, mock_client):
    ...
    mock_client.get_data.side_effect = [
        # NABO Focus
        {"OB5IBW001180FQ10640": [{"row": [{"SUBJECT": "보고서1", "REG_DATE": "2024-01-01", "LINK_URL": "http://nabo.go.kr/1"}]}]},
        # News
        {"O5MSQF0009823A15643": [{"row": [{"V_TITLE": "뉴스1", "DATE_RELEASED": "2024-01-02", "URL_LINK": "http://news.go.kr/1"}]}]}
    ]
...
async def test_analyze_committee_performance(smart_service, mock_client):
    mock_client.get_data.side_effect = [
        {}, # 22nd bills
        {"O4K6HM0012064I15889": [{"row": [
            {"BILL_ID": "PRC_21_1", "BILL_NAME": "가결법안", "CURR_COMMITTEE": "법제사법위원회", "PROC_STATUS": "원안가결", "LINK_URL": "x"}
        ]}]}, # 21st bills
        {"OND1KZ0009677M13515": [{"row": [{"BILL_ID": "PRC_21_1", "VOTE_TCNT": 100, "YES_TCNT": 90, "PROC_RESULT_CD": "가결"}]}]}, # Voting summary
        {}, # Reports
        {}  # News
    ]
